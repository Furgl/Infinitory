...
public class SlotsDefaultedList<E extends Slot> extends DefaultedList<E> {

	private List<E> delegate;
	private IScreenHandler handler;

	public static SlotsDefaultedList<Slot> of(IScreenHandler handler) {
		return new SlotsDefaultedList<>(handler, Lists.newArrayList(), null);
	}

	protected SlotsDefaultedList(IScreenHandler handler, List delegate, E initialSlot) {
